...
@media (max-width: 768px) {
  ...
  .tm-download-btns { flex-direction: row !important; width: 100% !important; }
  .tm-download-btns a { flex: 1 1 0 !important; min-width: 0 !important; padding: 0.55rem 0.5rem !important; font-size: 0.7rem !important; justify-content: center !important; }
  .tm-download-btns a svg { width: 16px !important; height: 16px !important; }
      ...
      <section id="download" style={{ padding: '6rem 1.5rem', background: '#F3F4F6', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="tm-split-row" style={{ ...container, display: 'flex', alignItems: 'center', gap: '4rem', position: 'relative', zIndex: 2 }}>
          ...
          <div ref={downloadLeft.ref} className={`tm-reveal-left tm-stagger-1 ${downloadLeft.visible ? 'tm-visible' : ''}`} style={{ flex: '1 1 45%' }}>
            ...
            {/* download buttons */}
            <div className="tm-download-btns" style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
              <a
                href="#"
